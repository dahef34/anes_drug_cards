    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          Center(
              heightFactor: 2,
              child: Image.asset('assets/usu_logo.png',
          ...
          ButtonBar(
            ...
            buttonTextTheme: ButtonTextTheme
                .normal, // this will take space as minimum as posible(to center)
            children: <Widget>[
              new RaisedButton(
                child: new Text('Navy'),
                onPressed: () async {
              ...
              new RaisedButton(
                ...
                onPressed: () async {
                  final url =
                      'https://www.airforce.com/careers/detail/certified-registered-nurse-anesthetist';
                  if (await canLaunch(url)) {
                    await launch(
                      url,
                      forceSafariVC: false,
