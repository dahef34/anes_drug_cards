...
class NotificationBloc extends ChangeNotifier {
  ...
  Future getData() async {
    ...
    await FirebaseFirestore.instance.collection('contents').get().then((QuerySnapshot snap) {
      var x = snap.docs;
    ...
    await FirebaseFirestore.instance.collection('notifications').doc('custom').collection('list').get().then((QuerySnapshot snap){
      List c = snap.docs;
      for (var item in c) {
        _ndata.add(item);
      }
