...
class CategoryItemPage extends StatefulWidget {
  ...
  CategoryItemPage({Key key,@required this.category, this.tag, this.color, this.description}) : super(key: key);

  @override
  _CategoryItemPageState createState() => _CategoryItemPageState(this.category, this.tag, this.color, this.description);
}
...
class _CategoryItemPageState extends State<CategoryItemPage> {
  ...
  final Color color;
  final String description;
  _CategoryItemPageState(this.category, this.tag, this.color, this.description);
